                    ...
                    <>
                        ...
                        {cartItems.map((item, key) => (
                            <div key={key} className="cart-iterm row">
                                ...
                                <div className="cart-text ccol-md-2 col-sm-5 mt-md-5 mt-3 mt-md-0 d-flex flex-column justify-content-center">
                                    <h6>Tên sản phẩm</h6>
                                    <Link to={`/products/${item.product}`}>
                                        <h4>{item.name}</h4>
                                    </Link>
                                </div>
                                <div className="cart-text col-md-2 col-sm-5 mt-md-5 mt-3 mt-md-0 d-flex flex-column justify-content-center">
                                    <h6>Kích cỡ{item.size}</h6>
                                </div>
